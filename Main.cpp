...
struct SeekMenu : mainmenu_commands
{
	...
	bool get_description(t_uint32 p_index, pfc::string_base & p_out) { p_out = "Opens a modal dialog with an edit box to seek within the playing track."; return true; }
...
GUID const SeekMenu::s_guid = 
{ 0x40e59e3, 0x442f, 0x4f41, { 0xb1, 0x8f, 0x8c, 0xe9, 0x69, 0x2e, 0x76, 0x78 } };
